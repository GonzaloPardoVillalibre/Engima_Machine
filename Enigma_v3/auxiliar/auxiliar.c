...
void setColorTexto(WORD colors) /*función que cambia el color del texto*/
{
...
void lp (char numero) /*función que borra los datos de la pantalla para poder escribir*/
{
