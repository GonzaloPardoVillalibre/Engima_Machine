...
void inicCifrado (void) /*Inicia el proceso de cifrado o descifrado cargando la configuración necesaria*/
{
    ...
    case 3:
        ...
        if(enigma.config.modeloETW =='B')
        {
            ...
            if (pLbb==NULL)
            {
                MessageBox(0,"Genere un archivo de configuracion para este modelo","FILE MISSING",MB_ICONERROR);
                return;
            }
            fclose(pLbb);
    ...
    gotoxy(3,15);
    printf("Seleccione una configuracion para un dia del mes: ");
    ...
    do /*Control para que la opcion este entre las disponibles*/
    {
        ...
        {
            if(enigma.config.dia<0) MessageBox(0,"Los dias del mes son positivos","Comentario para torpes",MB_ICONERROR);
            if(enigma.config.dia>31) MessageBox(0,"El numero debe estar entre 1-31","Comentario para torpes",MB_ICONERROR);
    ...
    MessageBox(0,"Introduca un mensaje letra a letra.\nPara terminar pulse [ESC]","INSTRUCCIONES",MB_ICONINFORMATION);
...
void procesoCifrado (struct sEnigma enigma)
{
    ...
    if(enigma.config.numRotores==3)
    {
        while(1) /*Bucle infinito*/
        {
            ...
            posi[1]=opStecker(posi[0], enigma.config.stecker); /*Devulve la letra compañera de la letra metida en stecker*/

            posi[2]=opRotor(posi[1], enigma.listaRotores.rotor[2], false); /*Devulve la letra compañera de la letra metida en rotor*/

            posi[3]=opRotor(posi[2],enigma.listaRotores.rotor[1], false);/*Devulve la letra compañera de la letra metida en rotor*/

            posi[4]=opRotor(posi[3], enigma.listaRotores.rotor[0], false);/*Devulve la letra compañera de la letra metida en rotor*/

            posi[5]=opReflector(posi[4],enigma.reflector);/*Devulve la letra compañera de la letra metida en el reflector*/

            posi[6]=opRotor(posi[5],enigma.listaRotores.rotor[0], true);/*Devulve la letra compañera de la letra metida en rotor*/

            posi[7]=opRotor( posi[6],enigma.listaRotores.rotor[1], true);/*Devulve la letra compañera de la letra metida en rotor*/

            posi[8]=opRotor(posi[7],enigma.listaRotores.rotor[2], true);/*Devulve la letra compañera de la letra metida en rotor*/

            posi[9]=devuelvepos(97+posi[8]); /*Llamada a la funcion auxiliar devuelvepos*/

            posi[9]=opStecker(posi[9], enigma.config.stecker); /*Devulve la letra compañera de la letra metida en el stecker*/
    ...
    else
    {
        while(1) /*Bucle infinito*/
        {
            ...
            posi[2]=opRotor(posi[1], enigma.listaRotores.rotor[3], false); /*Devulve la letra compañera de la letra metida en rotor*/

            posi[3]=opRotor(posi[2],enigma.listaRotores.rotor[2], false);/*Devulve la letra compañera de la letra metida en rotor*/

            posi[4]=opRotor(posi[3],enigma.listaRotores.rotor[1], false); /*Devulve la letra compañera de la letra metida en rotor*/

            posi[5]=opRotor(posi[4], enigma.listaRotores.rotor[0], false);/*Devulve la letra compañera de la letra metida en rotor*/

            posi[6]=opReflector(posi[5],enigma.reflector);/*Devulve la letra compañera de la letra metida en el reflector*/

            posi[7]=opRotor(posi[6],enigma.listaRotores.rotor[0], true);/*Devulve la letra compañera de la letra metida en rotor*/

            posi[8]=opRotor( posi[7],enigma.listaRotores.rotor[1], true);/*Devulve la letra compañera de la letra metida en rotor*/

            posi[9]=opRotor(posi[8],enigma.listaRotores.rotor[2], true);/*Devulve la letra compañera de la letra metida en rotor*/
            ...
            posi[11]=opStecker(posi[11], enigma.config.stecker); /*Devulve la letra compañera de la letra metida en el stecker*/
...
void cierraArchivosMensaje (FILE *ptPlano, FILE *ptCifrado) /*Se encarga del correcto cierre de los archivos*/
{
    ...
    {
        MessageBox(0,"NO SE PUEDE CERRAR EL FICHERO","TextoPlano",MB_ICONERROR);
