...
void configuracion 	(struct sEnigma *pEnigma)
{
    ...
    pEnigma->listaRotores.rotor=malloc(pEnigma->config.numRotores * sizeof(struct sRotor)); /*reserva dinamica el vector de rotres de 3 o 4 de tamaño */
    ...
    gotoxy(3,15);
    scroll(" PULSE UNA TECLA PARA CONTINUAR",32);
